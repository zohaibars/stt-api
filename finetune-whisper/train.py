...
#     # Replace -100 with the pad_token_id (to handle padding correctly)
#     label_ids[label_ids == -100] = processor.tokenizer.pad_token_id

#     # Decode the predicted and label IDs to readable strings
#     pred_str = processor.tokenizer.batch_decode(pred_ids, skip_special_tokens=True)
#     label_str = processor.tokenizer.batch_decode(label_ids, skip_special_tokens=True)

#     # Handle single-word or very short sequences gracefully
#     if len(pred_str) == 0 or len(label_str) == 0 or any(len(s.split()) < 2 for s in pred_str + label_str):
#         print("Warning: One or more sequences are too short for proper metric evaluation.")
#         return {"wer": None}

#     # Normalize predictions and labels if required
...
trainer.train()
print('DONE TRAINING')
# python train.py --train_datasets "Split Dataset/train" --eval_datasets "Split Dataset/valid"